...
Our main claim (Theorem~\ref{thm:odd-layer-global-1}) is that every odd \(x\equiv 1,5\pmod 6\) reaches \(1\) in finitely many accelerated odd Collatz steps. The method is modular:
...
\begin{table}[H]
\centering
\caption{Mapping of main theoretical results to formal proofs.}
\label{tab:coq-index}
